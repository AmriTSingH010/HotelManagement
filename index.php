		...
		<div class="contact-bnr-w3-agile">
			<ul>
				<li><i class="fa fa-envelope" aria-hidden="true"></i><a
						href="mailto:amrit.ssr123@gmail.com">amrit.ssr123@gmail.com</a></li>
				<li><i class="fa fa-phone" aria-hidden="true"></i>+91 9122126741</li>
				<li class="s-bar">
					<div class="search">
	...
	<div class="about-wthree" id="about">
		<div class="container">
			<div class="ab-w3l-spa">
				...
				<p class="about-para-w3ls">This is the page where you connect with visitors, build trust and persuade
					potential guests about your hotel. </p>
				...
				<div class="w3ls-info-about">
					...
					<p>We provide the best services for the customers. </p>
				</div>
			</div>
			<div class="clearfix"> </div>
		</div>
				...
				<div class="advantage-bottom">
					<div class="col-md-6 advantage-grid left-w3ls wow bounceInLeft" data-wow-delay="0.3s">
						<div class="advantage-block ">
							...
							<p>We also provide the facility that the costumer can pay the charge at the time of checked out.</p>
					...
					<div class="col-md-6 advantage-grid right-w3ls wow zoomIn" data-wow-delay="0.3s">
						<div class="advantage-block">
							...
							<p>Our hotel also provide the facility of restaurant so you can order food at anytime.</p>
		...
		<div class="container">
			...
			<div id="horizontalTab">
				<ul class="resp-tabs-list">
					<li>
						<img src="images/my1.jpg" alt=" " class="img-responsive" width="125px" />
					</li>
					...
					<ul class="slides">
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Nice Place, Have a great Experience here.  </p>
								<h5>Julia Rose</h5>
								<p>Germany</p>
							</div>
							<div class="clearfix"> </div>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Excellent stay! The hotel modern amenities, friendly staff, and stunning views made my trip memoriable. </p>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Impeccable service, comfortable rooms, and great amenities. Will definitely return on my next trip. </p>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Fantastic stay at the hotel! Impeccable service, comfortable rooms, and stunning views. Will definitely return for another memorable experience.</p>
								<h5>Amie Bublitz</h5>
								<p>Switzerland</p>
							</div>
							<div class="clearfix"> </div>
	...
	<section class="contact-w3ls" id="contact">
		<div class="container">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
				...
				<p class="contact-agile1"><strong>Phone :</strong>+91 9122126741</p>
				<p class="contact-agile1"><strong>Email :</strong> <a
						href="mailto:amrit.ssr123@gmail.com">amrit.ssr123@gmail.com</a></p>
				<p class="contact-agile1"><strong>Address :</strong> Goa, India</p>
